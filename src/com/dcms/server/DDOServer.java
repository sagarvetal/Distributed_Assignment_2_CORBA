...
/**
 * DDO Server Class
 * Create server instance for DDO location
 */
...
public class DDOServer {
    ...
    public static void main(String[] args) {
    	...
    	try{
            ...
            final NameComponent path[] = ncRef.to_name(LocationConstants.DOLLARD);
            ncRef.rebind(path, href);
       
            System.out.println("#========= Dollard-des-Ormeaux Server is ready and waiting =========#");
            orb.run();
